...
function Contact() {
  ...
  return (
    <div className="bg-[#222831] text-white  mx-auto flex flex-col md:flex-row items-start justify-between  w-full border pt-55">
      ...
      {/* Right Section */}
      <div className="w-full md:w-1/2 mt-10 md:mt-15 pl-0 md:pl-8 flex flex-col items-start justify-center gap-4 border ">
        <p className="text-[#948979] text-3xl">example@email.com</p>
        <p className="text-[#948979] text-3xl">+91 9876543210</p>
      </div>
    </div>
  );
}
