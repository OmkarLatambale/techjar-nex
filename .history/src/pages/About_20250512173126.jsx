        ...
        <section className="bg-[#222831] text-white py-2">
          ...
          <div className="max-w-[73rem] mx-auto px-6 flex flex-col md:flex-row items-center justify-between space-y-10 md:space-y-0">
            <div className="md:w-1/2 space-y-6">
              <p className="text-xl text-[#dfd0b8] ">
                NEX.AI uses <span className="text-5xl">AI</span> to make hiring
                easier for companies, vendors, and job candidates. It
                streamlines the hiring process by screening resumes and
