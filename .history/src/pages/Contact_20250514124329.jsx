...
function Contact() {
  ...
  return (
    <div className="bg-[#222831] text-white p-10 rounded-lg mx-auto flex flex-col md:flex-row items-start justify-between mt-10 md:mt-20 max-w-100% border">
      <h5 className="relative -top-2 left-4 text-[#948979] text-sm font-semibold border border-[#948979] rounded-3xl w-35 px-4 py-0.5 align-center">
        Contact Us
      </h5>
      {/* Left Section */}
