...
function Contact() {
  ...
  return (
    <div className="bg-[#222831] text-white p-10 rounded-lg mx-auto flex flex-col md:flex-row items-start justify-between  max-w-100% border pt-55">
      <h5 className="relative -top-30 left-12 border  rounded-3xl border-[#948979] back text-[#948979] w-30 px-4 py-0.5 text-xs ml-2">
        Contact Us
      </h5>
      {/* Left Section */}
