...
function Contact() {
  ...
  return (
    <div className="relative bg-[#222831] text-white mx-auto flex flex-col md:flex-row items-center justify-center w-full py-16 px-4 md:gap-12 border">
      {/* Contact Us Label (Top Left) */}
      <h5 className="absolute top-8 left-18 border border-[#948979] rounded-3xl text-[#948979] px-4 py-1 text-sm">
        Contact Us
      </h5>
