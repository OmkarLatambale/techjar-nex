...
function Contact() {
  ...
  return (
    <div className="bg-[#222831] text-white  mx-auto flex flex-col md:flex-row items-start justify-between  w-full border pt-55 justify-center">
      ...
      {/* Right Section */}
      <div className="w-full md:w-1/2  pl-0 md:pl-8 flex flex-col items-start justify-center gap-4 border  h-120">
