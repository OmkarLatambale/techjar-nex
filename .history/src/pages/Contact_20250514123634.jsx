...
function Contact() {
  ...
  return (
    <div className="bg-[#222831] text-white p-10 rounded-lg mx-auto flex flex-col md:flex-row items-start justify-between mt-10 md:mt-20 max-w-5xl">
      {/* Left Section */}
      <div className="w-full md:w-1/2 pr-0 md:pr-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <input
            ...
            required
            className="w-full p-3 text-lg rounded-md border-none bg-[#393e46] text-white placeholder-[#948979] text-center"
          />
          <input
            type="email"
            id="email"
            ...
            required
            className="w-full h-15 p-3 text-lg rounded-md border-none bg-[#393e46] text-white placeholder-[#948979] text-center"
          />
          <textarea
            id="message"
            name="message"
