...
function Contact() {
  ...
  return (
    <div className="bg-[#222831] text-white p-10 rounded-lg mx-auto flex flex-col md:flex-row items-start justify-between  max-w-100% border pt-40">
      <h5 className="relative -top-25 left-4 text-[#948979] text-sm font-semibold border border-[#948979] rounded-3xl w-35 px-3 py-0.5">
        Contact Us
      </h5>
      {/* Left Section */}
