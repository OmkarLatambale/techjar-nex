      ...
      <div className="bg-[#222831] border rounded-2xl border-[#DFD0B8]">
        <nav className="flex justify-between items-center px-12 py-6">
          ...
          <div className="flex gap-4">
            <button className="border border-[#948979] px-4 py-1 rounded-md text-[#DFD0B8] hover:bg-[#948979] hover:text-[#393e46]">
              Post a Job
            </button>
            <button className="border border-[#948979] px-4 py-1  rounded-md text-[#DFD0B8]">
              Login
            </button>
          </div>
        </nav>
