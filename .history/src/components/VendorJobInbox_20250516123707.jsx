    ...
    <div className="flex h-screen font-sans">
      ...
      <div className="w-3/4 bg-[#948979] overflow-y-auto">
        ...
        <div className="flex gap-8">
          <button className="bg-[#dfd0b8] text-[#393e46] px-6 py-2 rounded hover:bg-[#393e46] hover:text-[#dfd0b8] transition">
            Candidate-List
          </button>
          <button className="bg-[#393e46] text-[#dfd0b8] px-6 py-2 rounded hover:bg-blue-700 transition">
            Send to sub vendor
          </button>
        </div>
      </div>
