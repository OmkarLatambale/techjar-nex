    ...
    <div className="min-h-screen flex items-center justify-center bg-[#1e222a] text-white px-4">
      <div className="w-full max-w-md bg-[#1e222a] p-10 rounded-xl shadow-md space-y-8">
        ...
        <button
          onClick={handleLogin}
          disabled={loading}
          className="w-full bg-[#2b2f38] text-[#DFD0B8] border border-[#948979] hover:bg-[#3a3f4b] py-2 rounded-full text-sm font-medium transition-all duration-200 disabled:opacity-50"
        >
