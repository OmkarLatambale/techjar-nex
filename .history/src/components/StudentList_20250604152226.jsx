    ...
    <div className="min-h-screen p-6 bg-[#222831] text-[#DFD0B8]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {students.map((student, idx) => (
          ...
          >
            <p className="font-bold text-lg">{student.name}yash</p>
            <p className="text-sm">Email: {student.email}yashvar12</p>
            <p className="text-sm">Contact: {student.contact}98765432</p>
            <p className="text-sm">
              Organization Name: {student.organization_name} tech
            </p>
            <p className="text-sm">
