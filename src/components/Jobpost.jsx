...
const Jobpost = () => {
  ...
  const handlePostJob = async (descriptionToPost) => {
    const newJob = {
      ...
      generated_jd: descriptionToPost, // keep line breaks
    };
    ...
    <div className="min-h-screen bg-[#1e222a] text-[#DFD0B8] relative">
      ...
      <div className="flex flex-col lg:flex-row gap-10 px-10 py-12">
        ...
        <div className="w-full lg:w-1/2 flex flex-col">
          <div className="bg-[#2b2f38] rounded-lg p-6 text-sm min-h-[500px] flex flex-col">
            <strong className="block mb-3 text-[#948979]">
          ...
          {hasGenerated && (
            <button
              onClick={() => {
                handlePostJob(editableDesc); // send full description with \n
              }}
